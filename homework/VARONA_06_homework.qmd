...
#I don't really know what the numbers for sigma are doing
#Also, not sure if the intercept prior should 
...
#I don't think that my data (dark line) fits well with the posterior samples. The dark line is more "peaky" than the posterior samples. So, the data show more values around 80 than the majority of posterior samples show. However, I'm not sure whether this is a problem? And if so, how?
